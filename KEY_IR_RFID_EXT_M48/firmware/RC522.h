...
//m48
#define NS_H PORTB |=(1<<PORTB0); //Установить "1" на линии SS
#define NS_L PORTB &=~(1<<PORTB0); //Установить "0" на линии SS

/*
//m328	arduino
#define NS_H PORTB |=(1<<PORTB2); //Установить "1" на линии SS
#define NS_L PORTB &=~(1<<PORTB2); //Установить "0" на линии SS
*/
